...
<html>
    <head>
        ...
        <title>SportsHouse | Modulo Asistencia</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="<?php echo base_url()?>index.php/Profesor" class="logo">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Modulo Asistencia
                        <small>Registre la asistencia de los socios a sus clases</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
                        <li class="active">Modulo Asistencia</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Clases Asociadas a <?php echo $user[0]->nombre . ' ' . $user[0]->apellido ?></h3>
                                </div>
                                <!-- /.box-header -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Alumnos Confirmados</h4>
                    </div>
