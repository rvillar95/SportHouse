...
<html>
    <head>
        ...
        <title>SportsHouse | Clases</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Clases
                        <small>Vea las Clases que los Entrenadores han dispuesto.</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab_1" data-toggle="tab">Clases Disponibles</a></li>
                                    <li><a href="#tab_2" data-toggle="tab">Clases Tomadas</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab_2">
                                        <div class="box">
                                            ...
                                            <main>
                                                <div class="box-body table-responsive no-padding">
                                                    <table id="tabla_clasesTomadas" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col" class="text-center">Id</th>
                                                                <th scope="col" class="text-center">Nombre</th>
                ...
                <div style="display: none;">
                    <input type="text" id='idClase'>
                    <input type="text" id='idUsuario' value="<?php echo $user[0]->idUsuario ?>">
                </div>
                <!-- /.content -->
            </div>
            <!-- /.content-wrapper -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Desea confirmar Asistencia a esta Clase?</h4>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger pull-left" data-dismiss="modal">Cerrar</button>
                        <button type="button" id="confirmar" class="btn btn-info">Confirmar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        <script>
            $(function () {
                ...
                $('#tabla_clases').DataTable({
                    "ajax": {
                        url: "<?php echo site_url() ?>index.php/getClaseSocio",
                        type: 'GET'
                    },
                    "columnDefs": [
                        {
                            "targets": 7,
                            "data": null,
                            "defaultContent": '<button type="button" id="btnIngresar" class="btn btn-success" data-toggle="modal" data-target="#modal-Ingreso"><i class="glyphicon glyphicon-share-alt"></i></button>'
                        }
                    ]
                });

                ('#tabla_clasesTomadas').DataTable({
                    "ajax": {
                        url: "<?php echo site_url() ?>index.php/getClaseSocioTomadas",
                        type: 'GET'
                    }
                });
            });
