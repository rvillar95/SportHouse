...
<html>
    <head>
        ...
        <title>SportsHouse | Rutinas</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Rutinas
                        <small>Vea las rutinas que los Entrenadores le asignaron.</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Aca podra encontrar tus rutinas creadas</h3>
                                </div>
                                <!-- /.box-header -->
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Fecha Siguiente Evaluacion</th>
                                                    <th scope="col">Entrenador</th>
                                                    <th scope="col">Ver Detalle</th>
                                                </tr>
                                            </thead>
                                            <tbody id="tbodyrutina">
        ...
        <script>
            $(function () {
                ...
                $("body").on("click", "#btnEditarRutina", function (e) {
                    e.preventDefault();
                    var datos = $(this).val();
                    $("#idRutina").val(datos);
                    getDetalleRutinaSocio();
                });
