...
<html>
    <head>
        ...
        <title>SportsHouse | Consejos</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Consejos
                        <small>Vea los consejos que los Entrenadores le asignaron.</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
                        <li class="active">Consejos</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Aca podra encontrar todas los consejos asociados</h3>
                                </div>
                                <!-- /.box-header -->
